...
def add_predictions(input_data):
    ...
    st.write("This model can assist medical professionals in making a diagnosis, but should not be used as subsstitute for professional diagonis. ")
...
def main():
    ...
    with st.container():
        ...
        st.write("Please connect this app to your cytology lab to help diagnose breast cancer from your tissue sample. This app predicts using the machine learning modek whether a breast mass is beningn or malignant based on the measurement it recieved from your cystosis lab.you can also update the measurements by hand using the sliders in the sidebar.")
