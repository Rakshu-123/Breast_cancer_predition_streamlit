...
def main():
    ...
    if os.path.exists(css_path):
        ...
        st.warning("⚠️ style.css not found. Styling will be minimal.")

    input_data = add_sidebar()

    with st.container():
        st.title("Breast Cancer Predictor")
        st.write("Update the measurements using the sliders in the sidebar. This app uses a trained ML model to predict whether a tumor is benign or malignant based on cell nucleus features.")
